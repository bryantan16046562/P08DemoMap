package com.example.a16046562.demomap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback(){
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                //each marker present on the map
                Marker cp = map.addMarker(new MarkerOptions()
                        .position(poi_CausewayPoint)
                        .title("Causeway Point")
                        .snippet("Shopping after class")
                        .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED /* <-- color of marker */)));
